  ...
  headerRight: () => (
    <>
      ...
      <TouchableOpacity onPress={() => navigation.navigate("Scan")} style={{ marginRight: 20 }}>
       ...
       <Text style={{ fontSize:18, color: 'black' }}>NEW</Text>
      </TouchableOpacity>
    </>
  ),
});
...
function HomeStackNavigator() {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Voqit.Fashion.in" component={HomeScreen} options={screenOptions} />
...
//   return (
//     <Stack.Navigator>
//       <Stack.Screen name="ProductDetails" component={ProductDetails} options={screenOptions} />
//       <Stack.Screen name="LadiesFashion" component={require('./screens/LadiesFashion').default} />
//     </Stack.Navigator>
//   );
// }
...
function BottomTabs() {
  return (
    ...
    >
      ...
      {/* <Tab.Screen name="Menu2" component={MenuStackNavigator} options={{ headerShown: false }} /> */}
